...
export default function CareersPage() {
  return (
    <main>
      ...
      {/* Philosophy */}
      <section className="bg-surface py-16 md:py-24" aria-labelledby="philosophy-heading">
        <div className="mx-auto max-w-container px-5 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-start">
            <div className="lg:col-span-3">
              <h2 id="philosophy-heading" className="text-2xl md:text-3xl font-semibold tracking-tight text-fg mb-6">
                How we work.
              </h2>
            ...
            <div className="lg:col-span-2">
              <div className="rounded-lg border border-line bg-raised p-6 md:p-8">
                <h3 className="text-sm font-mono font-medium uppercase tracking-[0.1em] text-muted mb-4">
                  Our stack
                </h3>
                <div className="flex flex-wrap gap-2">
                  {['Next.js', 'TypeScript', 'Tailwind CSS', 'Headless WP', 'Vercel', 'React', 'WPGraphQL', 'Zod'].map((tech) => (
                    <span
                      key={tech}
                      className="font-mono text-xs font-medium px-2.5 py-1 rounded-md bg-raised border border-line text-fg"
                    >
                      {tech}
                    </span>
                  ))}
      ...
      {/* What we look for */}
      <section className="bg-raised py-16 md:py-24" aria-labelledby="traits-heading">
        <div className="mx-auto max-w-container px-5 md:px-8">
          <div className="max-w-2xl mb-12">
            <h2 id="traits-heading" className="text-3xl md:text-[2.5rem] font-semibold tracking-tight leading-[1.1] text-fg">
              What we look for.
            </h2>
      ...
      {/* Current openings */}
      <section className="bg-surface py-16 md:py-24" aria-labelledby="openings-heading">
        <div className="mx-auto max-w-container px-5 md:px-8">
          <h2 id="openings-heading" className="text-2xl md:text-3xl font-semibold tracking-tight text-fg mb-8">
            Current openings
          </h2>
          <div className="max-w-2xl rounded-lg border border-line bg-raised p-6 md:p-8">
            <p className="text-base font-semibold text-fg mb-2">No open roles right now.</p>
            ...
            <a
              ...
              className="mt-5 inline-flex items-center gap-1.5 text-sm font-medium text-accent hover:text-accent-hover transition-colors underline-offset-4 hover:underline"
            >
              hello@driftpilot.ca →
            </a>
          </div>
